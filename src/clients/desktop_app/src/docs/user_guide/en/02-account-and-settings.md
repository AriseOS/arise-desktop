...
- Log in with your credentials to access all Ami features.
...
- Configure app-level preferences (for example: language or behavior options if available).
- Log out of the current account.

When you log out, Ami clears local session information and returns you to the login screen.
