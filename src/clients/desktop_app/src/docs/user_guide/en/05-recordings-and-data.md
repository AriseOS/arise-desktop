...
- See the sequence of recorded actions.
...
- Collections store results or reference data.
- You can open a collection to inspect entries and structure.

Future versions may add more import/export options; this chapter focuses on the current UI behavior.
