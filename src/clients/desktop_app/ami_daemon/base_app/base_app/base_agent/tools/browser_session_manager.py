...
class BrowserSessionManager:
    ...
    async def get_or_create_session(
        ...
        # Create browser-use BrowserProfile
        logger.info(f"⚠️  [DEBUG] Setting highlight_elements=False in BrowserProfile")

        # Chrome arguments to hide automation flags
        # Note: browser-use already removes --enable-automation by default in ignore_default_args
        chrome_args = [
        ...
        profile = BrowserProfile(
            ...
            keep_alive=keep_alive,  # Keep browser running
