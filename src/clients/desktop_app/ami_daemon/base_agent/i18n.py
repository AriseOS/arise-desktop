...
sent via SSE events (AgentReportData, DecomposeProgressData).
"""
...
def t(key: str, lang: str = "en", **kwargs) -> str:
    ...
    Args:
        key: Dot-separated translation key (e.g. "executor.running").
        lang: Language code ("en" or "zh"). Defaults to "en".
        **kwargs: Interpolation variables for .format().

    Returns:
        Translated and interpolated string.
        Falls back to English if lang not found, then to the key itself.
    """
