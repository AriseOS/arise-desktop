...
from src.common.memory.ontology.action import Action, TransitionEdge
...
from src.common.memory.ontology.intent import AtomicIntent, Intent
...
from src.common.memory.ontology.state import SemanticState, State
from src.common.memory.ontology.query_result import (
    NavigationResult,
    QueryResult,
    SubTaskResult,
    TaskResult,
